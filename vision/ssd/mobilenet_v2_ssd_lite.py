...
def create_mobilenetv2_ssd_lite(num_classes, num_gender_classes=3, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False):
    ...
    gender_headers = ModuleList([
        SeperableConv2d(in_channels=round(576 * width_mult), out_channels=6 * num_gender_classes, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=1280, out_channels=6 * num_gender_classes, kernel_size=3, padding=1),
